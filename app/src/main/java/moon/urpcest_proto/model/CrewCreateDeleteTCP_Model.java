...
public class CrewCreateDeleteTCP_Model implements Runnable {
    ...
    public CrewCreateDeleteTCP_Model(String _msg, mGlobal mGlobalVar, boolean mFlag) {
        this.msg = _msg;
    ...
    public void run() {
        ...
        try {
            ...
            try {
                ...
                endFlag = true;
                if(mFlag)
                    mGlobalVar.mCrew.setmCrew_no(Integer.valueOf(return_msg));
            }
        } catch (Exception e) {
