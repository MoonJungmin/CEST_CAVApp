...
import static moon.urpcest_proto.utils.JSON_Parser.getTypeMember;
...
public class LoginTCP_Model implements Runnable {
    ...
    public LoginTCP_Model(String _msg, mGlobal mGlobalVar) {
        this.msg = _msg;
